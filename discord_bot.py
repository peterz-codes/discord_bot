...
def get_context():
    chanel_list = ['956179001074933790']
    headr = {
        "Authorization": "NDQyNTEyNjU2Nzc2Mjk4NDk3.YjqiDQ.-ksmOfS_TeqkF2GDD8UFjtiKnjM",
...
def chat():
    chanel_list = ['956179001074933790']
    authorization_list = [
        'NDQyNTEyNjU2Nzc2Mjk4NDk3.YjqiDQ.-ksmOfS_TeqkF2GDD8UFjtiKnjM']
